...
class AnkerSolixApiExport:
    ...
    def __init__(
        ...
        # get the api client from passed object
    ...
    def export_data(  # noqa: C901
        ...
        try:
            ...
            if self.export_common_data():
                ...
                self.api_power.update_sites(fromFile=True)
                self.api_power.update_device_details(fromFile=True)
                self.api_power.update_site_details(fromFile=True)
                self.api_power.update_device_energy(fromFile=True)
                self._logger.info(
    ...
    def query_common_data(self) -> bool:
        ...
        if not self.api_power.sites | self.api_power.devices:
            ...
            self.api_power.get_bind_devices()
        self._logger.info(
    ...
    def export_common_data(self) -> bool:
    ...
    def export_power_service_data(self) -> bool:
    ...
    def export_charging_energy_service_data(self) -> bool:
    ...
    def export_charging_hes_svc_data(self) -> bool:
