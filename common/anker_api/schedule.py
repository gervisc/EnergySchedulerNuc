...
def set_device_load(
    ...
    return self.get_device_load(siteId=siteId, deviceSn=deviceSn, fromFile=toFile)
...
def set_device_parm(
    ...
    paramType: was always string "4" for SB1, but SB2 and later needs "6" and a different structure. SB3 may use 13 for data authorization setting
               ...
               additional controls to modify the corresponding device settings
        ...
        if paramType in [SolixParmType.SOLARBANK_STATION.value]:
            ...
            if setId := paramData.get("id"):
                ...
                for sn in [
                    ...
                    self.set_power_cutoff(deviceSn=sn, setId=setId, toFile=toFile)
...
def set_sb2_home_load(  # noqa: C901
    self: AnkerSolixApi,
    siteId: str,
    deviceSn: str,
    preset: int | None = None,
...
def set_sb2_use_time(  # noqa: C901
    self: AnkerSolixApi,
    siteId: str,
    deviceSn: str,
